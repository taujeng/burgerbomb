const drinksData = {
    ...
    options: [
        { id: 1, name: 'Coca-Cola', price: { small: 1.99, medium: 2.49, large: 2.99 },  iceOptions: ['Ice', 'No Ice'], },
        { id: 2, name: 'Sprite', price: { small: 1.99, medium: 2.49, large: 2.99 },  iceOptions: ['Ice', 'No Ice'], },
